...
import { faAngleDown, faAngleRight, faArrowRight, faCog, faCheck, faCheckCircle, faExclamationCircle, faExclamationTriangle, faFlag, faInfo, faInfoCircle, faTrash, faTrashAlt, faUserCheck } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <>
            ...
            <div className="brand-buttons-content">
                ...
                <a href="#" className="googlebutton"><FontAwesomeIcon icon={faGoogle} size="1x" />
                    .btn-google</a>
                <a href="#" className="facebookbutton"><FontAwesomeIcon icon={faFacebookF} size="1x" />
                    .btn-facebook</a>
            </div>
        </>
    )
            ...
            <div className="split-buttons-content">
                ...
                {icons.map(({ name, code, title }) =>
                    <div className="spliticonbuttondiv">
                        <a href="#" style={{ "backgroundColor": code }} className="spliticonbutton" >
                ...
                <div className="spliticonbuttondiv">
                    <a href="#" className="spliticonbutton" >
